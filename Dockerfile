...
RUN apt-get update -y && apt-get install --no-install-recommends -y -q wget python build-essential ca-certificates gcc make ruby ruby-dev git git-core libfreetype6 libicu-dev libpng-dev libjpeg-dev flex bison gperf
